        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-base-content/70 max-w-2xl mx-auto leading-relaxed mb-8">
              A dedicated markdown reader designed for developers and
              researchers. Load all your markdown notes, documentation, and
              articles in one place for seamless reading with perfect rendering
              of math formulas and diagrams.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-16">
            <div className="card bg-base-200 shadow-sm">
              <div className="card-body">
                ...
                <p className="text-base-content/80 mb-4">
                  ...
                  distraction-free interface that lets you focus on your notes
                  and documentation with optimal typography and spacing.
                </p>
            ...
            <div className="card bg-base-200 shadow-sm">
              <div className="card-body">
                ...
                <p className="text-base-content/80 mb-4">
                  ...
                  ensures every mathematical expression displays perfectly in
            ...
            <div className="card bg-base-200 shadow-sm">
              <div className="card-body">
                ...
                <p className="text-base-content/80 mb-4">
                  ...
                  to continue reading exactly where you left off. All your
                  loaded notes remain accessible between sessions.
                </p>
                <div className="flex flex-wrap gap-2">
            ...
            <div className="card bg-base-200 shadow-sm">
              <div className="card-body">
                <h2 className="card-title text-xl mb-3">
                  🖨️ Share Your Reading
                </h2>
                <p className="text-base-content/80 mb-4">
                  Export your beautifully rendered notes to PDF for sharing or
                  archiving. Perfect for research papers, documentation, or
                  study materials that you want to read offline.
                </p>
                <div className="flex flex-wrap gap-2">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="card bg-base-200 shadow-sm">
                <div className="card-body p-6">
                  ...
                  <p className="text-sm text-base-content/70">
                    View flowcharts, sequence diagrams, and architectural
                    diagrams directly in your reading session.
                  </p>
                </div>
              </div>
              ...
              <div className="card bg-base-200 shadow-sm">
                <div className="card-body p-6">
                  ...
                  <p className="text-sm text-base-content/70">
                    Read GitHub Flavored Markdown with tables, task lists, and
                    all standard formatting for documentation.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="card bg-base-200 shadow-sm">
              <div className="card-body">
                ...
                <p className="text-base-content/70 mb-6 max-w-md mx-auto">
                  Ready to organize and read all your markdown notes in one
                  place? Load your files and start your focused reading session.
                </p>
